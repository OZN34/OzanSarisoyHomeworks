...
class TableViewController: UITableViewController, NSFetchedResultsControllerDelegate{
    ...
    //bu fonksiyon veritabanından verileri getiriyor
    ...
    override func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCell.EditingStyle, forRowAt indexPath: IndexPath) {
        ...
        pc.delete(managedObject)
            ...
            let alertController = UIAlertController(title: "Silmek istediğinizden emin misiniz ? ", message: "Çıkış yaptıktan sonra burdaki işleminiz iptal edilicektir.", preferredStyle: .alert)

            let deleteAction = UIAlertAction(title: "Evet", style: .destructive, handler: { (action) in
                self.tableView.deleteRows(at: [indexPath], with: .fade)
            })
            alertController.addAction(deleteAction)

            let cancelAction = UIAlertAction(title: "Hayır", style: .default, handler: delete)
